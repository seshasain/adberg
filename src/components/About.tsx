...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gray-50" role="main">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Mission Statement */}
        <div className="text-center mb-20">
          <h2 className="font-montserrat font-bold text-3xl md:text-4xl text-secondary mb-6">
            About SwiftReel AI Studio
          </h2>
          <div className="max-w-4xl mx-auto">
            <p className="font-opensans text-xl text-gray-600 leading-relaxed mb-8">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="font-montserrat font-bold text-2xl md:text-3xl text-secondary mb-4">
              Meet Our Team
            </h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <Card className="text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-0 shadow-lg rounded-2xl">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {whyAiFirst.map((reason, index) => (
              <div key={index} className="animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <Card className="h-full text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-0 shadow-lg rounded-2xl">
                  <CardContent className="p-8">
                    <div className="text-4xl mb-6">{reason.icon}</div>
                    <h4 className="font-montserrat font-semibold text-xl text-secondary mb-4">
                      {reason.title}
                    </h4>
        ...
        <div className="mt-20 bg-white rounded-2xl p-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="font-opensans text-gray-600">Happy Clients</div>
            </div>
            <div>
              <div className="font-montserrat font-bold text-3xl text-primary mb-2">10K+</div>
              <div className="font-opensans text-gray-600">Videos Created</div>
            </div>
            <div>
              <div className="font-montserrat font-bold text-3xl text-primary mb-2">50+</div>
              <div className="font-opensans text-gray-600">Countries Served</div>
            </div>
            <div>
              <div className="font-montserrat font-bold text-3xl text-primary mb-2">99%</div>
              <div className="font-opensans text-gray-600">Satisfaction Rate</div>
            </div>
          </div>
        </div>
      </div>
